...
#ifndef NETWORKING1_SWIFT_H
#define NETWORKING1_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NetWorking1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface CoursesViewController (SWIFT_EXTENSION(NetWorking1)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface CoursesViewController (SWIFT_EXTENSION(NetWorking1)) <UITableViewDelegate>
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified courseImage;
...
@interface WebViewController (SWIFT_EXTENSION(NetWorking1)) <WKNavigationDelegate>
